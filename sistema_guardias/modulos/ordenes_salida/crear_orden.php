...
<head>
    ...
    <title>Crear Orden de Salida - Sistema de Guardias</title>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0 text-primary">
                <i class="fas fa-car me-2"></i>Nueva Orden de Salida
            </h2>
        ...
        <div class="card card-shadow">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="fas fa-file-alt me-2"></i> Formulario de Orden</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="procesar_orden.php" method="post" id="formOrden">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="fecha_retorno" name="fecha_retorno">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Establecer fecha/hora mínima para salida (ahora)
            const now = new Date();
            const timezoneOffset = now.getTimezoneOffset() * 60000;
            const localISOTime = (new Date(now - timezoneOffset)).toISOString().slice(0, 16);
            document.getElementById('fecha_salida').min = localISOTime;
            document.getElementById('fecha_retorno').min = localISOTime;
        });
    </script>
</body>
</html>